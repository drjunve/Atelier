...
window.onload = function() {
	<c:choose>
		<%--회원가입 성공--%>
		<c:when test="${regSuc == '1'}">
			alert("회원가입에 성공했습니다. 로그인 해주세요.");
		</c:when>
		<%--회원가입 실패--%>
		<c:when test="${regSuc == '0'}">
			alert("회원가입에 실패했습니다. 다시 시도해 주세요.");
		</c:when>
		<%--로그인 실패(성공시 메인페이지로감)--%>
		<c:when test="${logSuc == '0'}">
		...
		<div class="row">
			<div class="col-xxl-6 d-grid mx-auto p-2">
				<ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
					<li class="nav-item" rols="presentation">
						<a class="nav-link text-dark" href="/login">로그인</a>
					</li>
					<li class="nav-item" rols="presentation">
						<a class="nav-link text-dark" href="/signup">회원가입</a>
					</li>
				</ul>
			</div>
		</div>
...
<c:when test="${loginPage == '1'}">
			<form name="logform" action="login.do" method="post">
				<table class="table table-borderless">
					<tr>
						<td colspan="2">
						<input name="logId" id="logId" type="email" value="${logId}" class="form-control" placeholder="EMAIL" />
						</td>
					</tr>
					<tr>
						<td colspan="2">
						<input name="logPass" id="logPass" type="password" class="form-control" placeholder="PASSWORD" />
						</td>
					</tr>
					<tr>
	<c:choose>
			...
			<form name="myMotherform" action="regist" method="post" onsubmit="return formValidate(this);" novalidate>
				<table class="table table-borderless">
					<tr>
						<td colspan="2" style="text-align: center;">
							<div style="display: inline-block; margin: 0 30px;">
								<button type="button" class="btn btn-outline-danger" data-bs-toggle="button">일반회원</button>
							</div> &nbsp;&nbsp;&nbsp;
							<div style="display: inline-block; margin: 0 30px;">
								<button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#staticBackdrop">작가회원</button>
								<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
									<div class="modal-dialog modal-dialog-centered">
									    <div class="modal-content">
									      <div class="modal-header">
									        <h5 class="modal-title" id="staticBackdropLabel">작가회원 가입하기</h5>
									        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
									      </div>
									      <div class="modal-body">
									        작가회원 가입은 일반회원 가입 후,<br/>
									        "마이페이지"의 "작가신청" 페이지에서<br/>
									        계속 진행해주세요.
									      </div>
					...
					<tr>
						...
						<span id="ruleSpan" data-bs-toggle="modal" data-bs-target="#usingRule" style=""><b><u>이용약관</u></b></span>과 
						<span id="ruleSpan2" data-bs-toggle="modal" data-bs-target="#infoRule"><b><u>개인정보취급방침</u></b></span>에 동의합니다.
						<div class="modal fade" id="usingRule" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="--bs-modal-width: 80% !important">
...
이상의 약관은 2017년 1월 1일부터 시행합니다.
						...
						<div class="modal fade" id="infoRule" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="--bs-modal-width: 80% !important">
							<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
							    <div class="modal-content">
							      <div class="modal-header">
							        <h5 class="modal-title" id="staticBackdropLabel">개인정보취급방침</h5>
							        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
							      </div>
							      <div class="modal-body">
<pre style="white-space: pre-wrap; font-family: 'Noto Sans KR', sans-serif;">
